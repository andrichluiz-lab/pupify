...
import { ArrowLeft, TrendingDown, Loader2, Calendar as CalendarIcon } from "lucide-react"
...
export default function NewExpensePage() {
  ...
  return (
    <>
      <AppTopbar
        title="Nova despesa"
        description="Cadastre uma saída financeira"
      />
        ...
        >
          <div className="flex flex-col gap-4 lg:col-span-2">
            ...
            <section className="rounded-lg border border-border bg-card p-5">
              <FieldSet>
                <FieldLegend className="text-sm font-medium">Dados da despesa</FieldLegend>
                <FieldGroup>
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <Field>
                      <FieldLabel htmlFor="category">Categoria *</FieldLabel>
                      <Select name="category" defaultValue="fornecedor">
                ...
                <FieldGroup>
                  ...
                  <Field>
                    ...
                    <Input
                      id="counterparty"
                      name="counterparty"
                      placeholder="Ex: Fornecedor XYZ, Empresa de luz"
                      required
                    />
                    <FieldDescription>Nome do fornecedor ou responsável</FieldDescription>
                  </Field>
                </FieldGroup>
              </FieldSet>
            </section>
