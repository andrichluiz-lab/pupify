...
import { ClinicForm } from "@/components/configuracoes/clinic-form"
      ...
      <div className="flex items-center gap-3 border-b border-border bg-background/80 px-4 py-3 backdrop-blur-md md:px-6">
        <div className="flex min-w-0 flex-1 items-center gap-3">
          <div className="flex min-w-0 flex-col leading-tight">
            <h1 className="truncate text-sm font-semibold tracking-tight">Configurações da Clínica</h1>
            <p className="truncate text-xs text-muted-foreground">Edite as informações da sua clínica</p>
          </div>
        </div>
      </div>
